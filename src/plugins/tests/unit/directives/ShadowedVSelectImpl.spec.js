...
commonDirectiveTests("ShadowedVSelect with string options", stringOptions, ShadowedVSelect, simpleImplementation, [{name:'v-select',  comp: vSelect}])

// Tests implementation
commonDirectiveTests("ShadowedVSelect with dict options", dictOptions, ShadowedVSelect, simpleImplementation, [{name:'v-select',  comp: vSelect}])
...
// Tests implementation
commonDirectiveTests("ShadowedVSelect with custom label dict options", customLabelDictOptions, ShadowedVSelect, customLabelOptionsImplementation, [{name:'v-select',  comp: vSelect}])